    ...
    <div style={{ display: "grid", gridTemplateRows: "1fr auto", height: "calc(100vh - 64px)" }}>
      <div style={{ padding: 16, overflow: "hidden" }}>
        <Card
          ...
          style={{ height: "100%" }}
          styles={{ body: { height: "100%", padding: 0, display: "flex", flexDirection: "column", background: "transparent" } }}
        >
          <div
            ref={scrollRef}
            style={{
      ...
      <div style={{ padding: 16, borderTop: "1px solid rgba(15,23,42,0.06)", background: "transparent" }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 8, alignItems: 'stretch' }}>
          <Input.TextArea
            ...
            placeholder={currentRoom ? "Your message..." : "Join a channel to write"}
          ...
          <Button
            ...
            loading={isLoading}
            disabled={!composer.trim() || !currentRoom || !user?.username?.trim()}
